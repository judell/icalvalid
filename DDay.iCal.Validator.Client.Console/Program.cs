...
namespace DDay.iCal.Validator
{
    class Program
    {
        ...
        static CommandLineArgument _OpenOutputFile = new CommandLineArgument(new string[] { "open" });
        static CommandLineArgument _IgnoreWarningsArgument = new CommandLineArgument(new string[] { "i", "ignore" });

        static CommandLineArgumentList _Arguments;
        static string _CalendarPath = null;
        static Exception _ValidationRuleLoadException = null;
        ...
        {
            Console.WriteLine();
            Console.WriteLine("icalvalid - iCalendar validator   |   Copyright (C) 2010 Douglas Day");            
            Console.WriteLine("----------------------------------------------------------------------------");
            ...
            Console.WriteLine("/of:<format>     | Sets the output filename when /o is set to 'file'.");
            Console.WriteLine("                 | Default is 'output.txt' or 'output.xml'.");
            Console.WriteLine("/open            | When the output is set to 'file', opens the resulting file.");
            Console.WriteLine();
